...
declare type KANSEN_TYPE = 'destroyer' | 'ddg' | 'light_cruiser' | 'heavy_cruiser' | 'large_cruiser' | 'munition_ship' | 'battleship' | 'battlecruiser' | 'aviation_battleship' | 'light_aircraft_carrier' | 'aircraft_carrier' | 'monitor' | 'repair_ship' | 'submarine' | 'submarine_carrier' | 'sailing_frigate';
