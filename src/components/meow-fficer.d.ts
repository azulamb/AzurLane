declare type MEOWFFICER_NAME = 'antenna' | 'ark' | 'asamaru' | 'beer' | 'bishamaru' | 'bugles' | 'bunny' | 'eagle' | 'katsumaru' | 'lady' | 'rose' | 'sg' | 'tofu' | 'edelweiss' | 'gral' | 'jiromaru' | 'marble' | 'pepper' | 'potato' | 'soup' | 'yoshimaru' | 'justice' | 'lime' | 'oscar' | 'pound' | 'steel' | 'takemaru';
